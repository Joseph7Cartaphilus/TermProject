    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "budget",
                    models.PositiveIntegerField(default=0, help_text="указать сумму в долларах", verbose_name="Бюджет"),
                ),
                (
                    "fees_in_usa",
                ...
                (
                    "actors",
                    models.ManyToManyField(related_name="film_actor", to="movie_app.actor", verbose_name="актеры"),
                ),
                (
                    "category",
                    models.ForeignKey(
                ...
                (
                    "directors",
                    models.ManyToManyField(related_name="film_director", to="movie_app.actor", verbose_name="режиссер"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "movie",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="movie_app.movie", verbose_name="фильм"
                    ),
                ),
                (
                    "parent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "star",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="movie_app.ratingstar", verbose_name="звезда"
                    ),
                ),
            ],
            options={
