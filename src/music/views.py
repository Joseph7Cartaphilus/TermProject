...
def playlist(request: HttpRequest, playlist_id) -> HttpResponse:
    ...
    return render(request, "playlist.html", {"track_lists": track_lists, "tracks": tracks})
...
def playlist_delete(request: HttpRequest, playlist_id) -> HttpResponse:
    ...
    if request.method == "POST":
        playlist.delete()
        return redirect("playlists")
    return render(request, "playlist_delete.html", {"playlist": playlist})
...
def playlist_edit(request: HttpRequest, playlist_id) -> HttpResponse:
    ...
    return render(request, "playlist_edit.html", {"form": form, "playlist": playlist})
